...
function Start-Screen {
    ...
    $tabControl = Add-TabControl -parentControl $form -tabControlWidth 750 -tabControlHeight 850 -tabControlLocationX 10 -tabControlLocationY 10
    ...
    $nestedTabControl1 = Add-TabControl -parentControl $tabPage1 -tabControlWidth 700 -tabControlHeight 800 -tabControlLocationX 10 -tabControlLocationY 10
    $nestedTabPage11 = Add-tabPage -tabControl $nestedTabControl1 -tabText "table"
    $table1 = Add-Table -parentControl $nestedTabPage11 -tableWidth 650 -tableHeight 600 -tableLocationX 10 -tableLocationY 10

    # Add a nested tab control to the second tab
    $nestedTabControl2 = Add-TabControl -parentControl $tabPage2 -tabControlWidth 700 -tabControlHeight 800 -tabControlLocationX 10 -tabControlLocationY 10
    $nestedTabPage21 = Add-tabPage -tabControl $nestedTabControl2 -tabText "table"
    $table2 = Add-Table -parentControl $nestedTabPage21 -tableWidth 650 -tableHeight 600 -tableLocationX 10 -tableLocationY 10

    # Add buttons to update the tables
    $updateTableButton1 = Add-Button -parentControl $nestedTabPage11 -buttonText "Update Table" -buttonLocationY 650 -buttonLocationX 300 -buttonWidth 100 -buttonHeight 30
    $updateTableButton1.Add_Click({
            ...
            Set-Table -table $table1 -data $newData -highlightPin 20
        })

    $updateTableButton2 = Add-Button -parentControl $nestedTabPage21 -buttonText "Update Table" -buttonLocationY 650 -buttonLocationX 300 -buttonWidth 100 -buttonHeight 30
    ...
    $testValuesButton1 = Add-Button -parentControl $nestedTabPage11 -buttonText "Test Values and Notify" -buttonLocationY 700 -buttonLocationX 275 -buttonWidth 150 -buttonHeight 30
    $testValuesButton1.Add_Click({
            Test-ValuesAndNotify -Pi 1 -pin 20 -startTime (Get-Date).AddDays(-1) -endTime (Get-Date)
        })

    $testValuesButton2 = Add-Button -parentControl $nestedTabPage21 -buttonText "Test Values and Notify" -buttonLocationY 700 -buttonLocationX 275
